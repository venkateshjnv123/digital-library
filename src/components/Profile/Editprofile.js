...
<div style={{overflow:"visible"}} className="datail container">
   ...
   <div className=" leave2" class="rounded float-end"> <img  src={Leave2}></img></div>
    <header className="profile text-center mt-5 pt-5"><h3>Edit profile</h3>
...
<form>
   ...
   <div className="ml-5"><button className="mt-4 pt-1 pb-1"  type="submit" value="Save">Save</button></div>
    </form></div></div>
    );
}
export default Edit;
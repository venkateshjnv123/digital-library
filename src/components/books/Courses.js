...
import './Courses.css';
import Courseimg1 from '../images/course img.svg';
...
function Courses(){
    ...
    return(
        <div className="courses">
            <div className="courseconst"><input type="text" readOnly value="Courses" ></input></div>
            <div><img src={Courseimg1} className="img1" alt={Courseimg1}></img></div>
            <div style={{textAlign:"center"}} className="mt-5 search"><input type="text" placeholder="Search for the couse" id="myInput" onKeyUp={filterFunction} className="searchbar"></input>
        </div>
